...
export default function Hero() {
  return (
    <div>
      <div
        id="home"
        className=" height justify-around my-5 mx-5 mr-5 ml-5 flex flex-col text-center md:flex-row space-x-10 "
      >
        <div className=" flex1  items-center  w-200">
          <img id="bg" className="flexitem" src={Bg} alt="imag" />
        </div>
        <div className="flex1 w-4/5 m-auto md:w-1/2">
          <h3 className="flexitem text-4xl  font-bold font-3xl">
            <span className=" color-gradient ">VCare - Electronic Health Record</span>
          </h3>
          <div className="hero-content flexitem">
            Welcome to VCare an EHR the modern solution for managing your healthcare
            practice. Our EHR software provides everything you need to
            streamline your workflow, improve patient care, and grow your
            practice. With EHR, you can: Schedule appointments and manage your
            calendar with ease, Chart and document patient visits quickly and
            accurately, Engage with patients using our secure patient portal,
            and Electronically prescribe medications and manage prescriptions
            <br />
            <br />
            "EHR has transformed the way I run my practice. It's intuitive, easy
            to use, and has all the features I need to provide the best possible
            care to my patients." - Dr. Jane Smith
          </div>
        </div>
      </div>

      <section className="pt-14 mt-7" id="about-us">
        <div className="text-5xl font-bold text-center pb-10 color-gradient">
          {" "}
          About us{" "}
        </div>
